...
cp /home/brian/whitelight/whitelight-backend/.env $BACKUP_DIR/backend.env 2>/dev/null && echo "✅ Backend .env backed up" || echo "⚠️  Backend .env not found"
cp /home/brian/whitelight/whitelight/.env $BACKUP_DIR/frontend.env 2>/dev/null && echo "✅ Frontend .env backed up" || echo "⚠️  Frontend .env not found"
...
git config --global --add safe.directory /home/brian/whitelight 2>/dev/null || true
